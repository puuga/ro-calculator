...
const links: Link[] = [
  ...
  { group: 'Memorial Dungeon', title: 'New Thanatos Tower (Guide)', path: 'https://ro.gnjoy.in.th/new-thanatos-tower-guide/', tags: ['Dungeon'] },
  ...
  { group: '4th Classes', title: '4th Classes', path: 'https://ro.gnjoy.in.th/4th_classes/characters/index.html', tags: [] },
  ...
  { group: 'System', title: 'Grade Weapon & Item Reform', path: 'https://ro.gnjoy.in.th/item-gradereform/', tags: [] },
